                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="section-title">
                                <h4 class="fs-5 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">¿CÓMO TE PODEMOS AYUDAR?</h4>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="service-image  wow fadeInRight" data-wow-duration="1s" data-wow-delay="1s">
                                <img src="https://preview.uideck.com/items/basic/assets/images/about1.svg" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="section-items">
                                ...
                                <div class="box-item d-flex wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.3s">
                                    <div class="icon"> <i class="lni lni-flag-alt"></i></div>
                                    <div class="flex-grow-1 text">
                                        <h4>Soporte</h4>
                                ...
                                <div class="box-item d-flex wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.5s">
                                    <div class="icon"> <i class="lni lni-flag-alt"></i></div>
                                    <div class="flex-grow-1 text">
                                        <h4>Soporte</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="section-items">
                                ...
                                <div class="box-item d-flex wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.6s">
                                    <div class="icon"> <i class="lni lni-flag-alt"></i></div>
                                    <div class="flex-grow-1 text">
                                        <h4>Soporte</h4>
                                        <p>Soporte en procesos de emisión o siniestros</p>
                                ...
                                <div class="box-item d-flex wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1.8s">
                                    <div class="icon"> <i class="lni lni-flag-alt"></i></div>
                                    <div class="flex-grow-1 text">
                                        <h4>Soporte</h4>
                                        <p>Implementación de soluciones de automatización de colas en plataformas presenciales</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="section-title wow fadeInRight" data-wow-duration="1s" data-wow-delay="1s">
                                ...
                                <p class="text">Optimizar la experiencia de tus pacientes te permitirá:</p>
                            </div>
                            <div class="section-items">
                                <div class="box-item d-flex wow fadeInRight" data-wow-duration="1s" data-wow-delay="1s">
                                    <div class="icon"> <i class="lni lni-rocket"></i></div>

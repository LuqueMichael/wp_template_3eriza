    ...
    <div class="container">
      <div class="row d-flex justify-content-between">
        <div class="col-12 col-md-12 mb-5 text-md-center col-lg-2">
          <a href="<?= home_url() ?>" target="_blank"><img class="w-auto mt-5" src="<?= get_template_directory_uri() ?>/assets/images/logo.png" alt=""></a>
          <h6 class="mt-3">Lo hacemos mejor y distinto</h6>
        </div>
        <div class="col-12 mb-3 col-md-3 col-lg-2 mb-sm-0">
          <h6>Servicios</h6>
          <ul class="list-unstyled li-space-lg p-small">
            <li><a href="#" target="_blank">Interacción con clientes - Front Office</a></li>
            <li><a href="#" target="_blank">Provisión de personal - Staffing</a></li>
            <li><a href="#" target="_blank">Soporte al negocio - Back Office</a></li>
          </ul>
        </div>
        <div class="col-12 mb-3 col-md-3 col-lg-2 mb-sm-0">
          <h6>Sobre Nosotros</h6>
          <ul class="list-unstyled li-space-lg p-small">
            <li><a href="https://3eriza.pe/nosotros/" target="_blank">Nosotros</a></li>
            <li><a href="https://3eriza.pe/empleos/" target="_blank">Empleos</a></li>
            <li><a href="https://3eriza.pe/blog/" target="_blank">Blog</a></li>
          </ul>
        </div>
        <div class="col-12 mb-3 col-md-3 col-lg-2 mb-sm-0">
          <h6>Ubicanos</h6>
        ...
        <div class="col-12 mb-3 col-md-3 col-lg-2 mb-sm-0">
          ...
          <ul class="social-media mb-2 d-flex justify-content-start my-3">
            ...
            <li><a href="mailto:contacto@3eriza.pe" target="_blank"><i class="fa fa-envelope"></i></a></li>
...
<div class="yaqua">
  <div class="yaqua-wrapper">
    ...
    <div class="thumb"></div>
    <div class="yaqua-content">
      <h1>Ayúdanos a llevar AGUA A MÁS peruanos.</h1>
      <p>Entérate cómo haciendo <a href="https://www.yaqua.pe/" target="_blank">click aquí</a></p>
      <a href="https://www.yaqua.pe/" target="_blank">
        <div class="foot"></div>
      </a>
    </div>
  </div>
